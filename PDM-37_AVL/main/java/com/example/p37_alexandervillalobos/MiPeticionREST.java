package com.example.p37_alexandervillalobos;
    ...
    protected String doInBackground(String... info) {
        ...
        try
        {
            ...
            if( info[0].contains("POST")) {
                URL url = new URL("https://api.telegram.org/bot6454167784:AAE8H9DqU2PS7pKXB_7Ltc3lU-8o8lLe6BA/sendMessage?text=Hola");
            ...
            if( info[0].contains("GET-SEND")){
                URL url = new URL("https://api.telegram.org/bot6454167784:AAE8H9DqU2PS7pKXB_7Ltc3lU-8o8lLe6BA/sendMessage?chat_id=6314595535&text=" + info[1]);
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setDoOutput(true);
            ...
            if( info[0].contains("GET-UPDATES")){
                URL url = new URL("https://api.telegram.org/bot6454167784:AAE8H9DqU2PS7pKXB_7Ltc3lU-8o8lLe6BA/getUpdates");
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setDoOutput(true);
                conn.setRequestMethod("GET");
                conn.setRequestProperty("Content-length", "0");
